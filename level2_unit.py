...
class LevelAUnitTests(unittest.TestCase):
    ...
    def test_post_html(self):
        ...
        html = interface.post_to_html(text)
        self.assertEqual("&lt;p&gt;Hello World <a href='http://example.org/'>http://example.org/</a> is it&lt;/p&gt;",
                         html)
        ...
        html = interface.post_to_html(text)
        self.assertEqual(
            "&lt;p&gt;Hello World <a href='http://example.org/home_page.html'>http://example.org/home_page.html</a> is it&lt;/p&gt;",
            html)
    ...
    def test_post_html_hashtag(self):
        """Test conversion of #hashtags in posts to HTML"""

        text = "Hello World #whatever"
        html = interface.post_to_html(text)
        self.assertEqual("Hello World <strong class='hashtag'>#whatever</strong>", html)
