...
"""
    ...
    def fixed_data(self):
        ...
        self.posts = [
            (1, '2017-02-20 01:45:06', 'Mandible',    'wkwaai yiynhmg rdcxnwuhy yxxzlieaxe yu waez efh odiipzqep cp qsaqp gkhhyxkb raguklag #ox qbml nuhb #mtzw yctpzdx uxxqibyw zhysw ugidbqii'),
            (2, '2017-02-20 00:54:53', 'Barfoo',      'edukmb zankyyu panhipscgo zkvoyg gaaeuogdzn lhpiemoaui ave aruckns conk we @Contrary nlyixitpd fianqsj #ync iou yoeifeodjo  sxxms umpcvu'),
            (3, '2017-02-20 00:04:40', 'Jimbulator',  '#sre ydpwg kau elepeeu dukouvya #ax jji #cvrwu yccq mxbdehwyna hyhhj oqyiibzrfl nilytlwqws yppu plggqfsfyn ggf snzxlxo qdjzzg iyjc '),
            (4, '2017-02-19 23:14:27', 'Contrary',    '#cfsidisk xvucuio ww yqoowit cjshcohaad euau vbzylol acpxixpsh qay @Bobalooba okl #gjyep'),
            (5, '2017-02-19 22:24:14', 'Mandible',    'mhdckmcys tdwioaxxa bviwczux wuhbalaa yiul xm cvauk stouea eexmahg vi uwy iy qp cifog eizjzmsaae eiixs aam #gye @Contrary zt '),
            (6, '2017-02-19 21:34:01', 'Mandible',    'eywam ooh ftmjr #swgsdd sp @Jimbulator frfikgij nquuz ovuezj edlxcejw'),
            (7, '2017-02-19 20:43:48', 'Bobalooba',   'uoro hgjkpzdyyx jsjtl tbnia egoetouzda vayiftdnlh tnh cpzd #rucaecv olkao osit bdqi vry oiweusczq wepf lptp gud pooezehvqu  oaywaeu '),
            (8, '2017-02-19 19:53:35', 'Contrary',    'qhopqrquy ayiwktwn uluefr oei savjdu #nrurcdrbq vuzdoaco trzbuj zpjetma xdjeooprhe fsvt rnx #gquax ctizac ssun nfdtiz #zocpybi @Bean'),
            (9, '2017-02-19 19:03:22', 'Barfoo',      'nx tdeekuyt inyevkn mravuos dwkbtp aaolctomnj ecleerbm raynuui exiymoz lyeywzt cnzyykgfkg jn ievbfe zfpaxga  guapoe @Jimbulator '),
            (10, '2017-02-19 18:13:09', 'Jimbulator', 'ieqm yaa ar cwynuy efil ewelkagj ujasyn nwyenbd ziirqnwek oycu eghrbew ybjyp ew na focbq jxfqarocy jsaa  tt atoitu ojnpswqk')]
